...
@extends('layouts.app')
@section('content')
<img class="animate__animated animate__fadeIn" src="images\clientes.png" style="width: 1310px; height:500px; position: absolute; filter: brightness(60%);">
<br><br><br><br><br><br><br><br>
<h1 class="animate__animated animate__backInDown" style="position: absolute; color:white; margin-left: 500px; font-family: 'DM Serif Display';"><strong>Nuestros Clientes</strong></h1><br><br>
...
<div class="container" style="background-color: white; position: relative;">
    ...
    <div class="columns">
        <div class="column">
            <img src="images\atexcaco.jpeg" type="button" style="border-radius: 50%; height: 290px; width: 300px; margin-left: 120px" class="btn" data-bs-toggle="modal" data-bs-target="#ModalAtex"> <br>
        </div>
        <div class="column">
            <br><br><br><br>
    ...
    <div class="columns">
        <div class="column">
            <img src="images\cafe.png" type="button" style="border-radius: 50%; height: 290px; width: 300px; margin-left: 120px" class="btn" data-bs-toggle="modal" data-bs-target="#ModalCafe"> <br>
        </div>
        <div class="column">
            <br><br><br><br>
            <h2 style="margin-left: -70px; font-family: 'DM Serif Display'">Cafe Finca Terminal</h2>
        </div>
    </div>
